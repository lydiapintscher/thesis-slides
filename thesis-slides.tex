...
\begin{frame}
\frametitle{Kollaborativ an einer Vision arbeiten}
\begin{block}{Amarok's new vision}
...
\begin{columns}
 \column{.5\textwidth}
   ``Will the team dashboard increase transparency?''
   \begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3,keepaspectratio=true]{./halo2a.png}
   \end{figure}
 \column{.5\textwidth}
   ``Will the release dashboard increase transparency?''
   \begin{figure}[h!]
    \centering
...
\begin{columns}
 \column{.5\textwidth}
   ``Do you think the process of creating the new vision was transparent/collaborative?''
   \begin{figure}[h!]
    \centering
    \includegraphics[scale=0.25,keepaspectratio=true]{./amarok1ef.png}
   \end{figure}
 \column{.5\textwidth}
   ``Do you think the process of creating the new vision can be used by other Free Software projects as well?''
   \begin{figure}[h!]
    \centering
...
\begin{columns}
 \column{.5\textwidth}
  ``Will the new feature tracking form/template improve collaboration between contributors/contributors and users?''
   \begin{figure}[h!]
    \centering
    \includegraphics[scale=0.25,keepaspectratio=true]{./amarok3bchalo3bc.png}
   \end{figure}
 \column{.5\textwidth}
 ``Will the new feature tracking form/template and roadmap increase transparency?''\newline
   \begin{figure}[h!]
    \centering
